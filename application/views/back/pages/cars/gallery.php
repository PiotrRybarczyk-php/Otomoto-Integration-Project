    ...
    <div class="br-mainpanel">
        <div class="pd-30">
            <h4 class="tx-gray-800 mg-b-5"><?= $car->title; ?>:
            </h4>
        ...
        <div class="br-pagebody mg-t-0 pd-x-30">
            ...
            <?php endif; ?>
            <form class="form-layout form-layout-2" action="<?php echo base_url() . 'panel/' . $this->uri->segment(2) . '/action_gallery/' . $car->id; ?>" method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="row align-items-center">
                                        <?php foreach ($pictures as $value) : ?>
                                            <div class="col-lg-4 col-md-6 text-center mb-3 align-self-center">
                                                <img src="https://ignaszak.pl/files/<?php echo $value->folder . '/' . $value->filename; ?>" class="img-thumbnail img-fluid align-middle">
                                                <div class="input-group">
                                                    <a href="<?php echo base_url(); ?>panel/settings/delete_photos/car_files/<?php echo $value->id; ?>" class="input-group-addon tx-size-sm lh-2" title="usuń zdjęcie">
