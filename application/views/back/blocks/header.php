...
<div class="br-sideleft overflow-y-auto">
  ...
  <div class="br-sideleft-menu">
    ...
    <a href="#" class="br-menu-link
        <?php if ($this->uri->segment(2) == 'cars' || $this->uri->segment(4) == 'cars') {
          echo 'active';
        } ?>">
      <div class="br-menu-item">
        <i class="menu-item-icon fa fa-server tx-20"></i>
        <span class="menu-item-label">Pojazdy</span>
        ...
        <div class="dropdown-menu dropdown-menu-header wd-300 pd-0-force">
          ...
          <div class="media-list">
            ...
            foreach (array_reverse($mails) as $value) : $i++; ?>
              <a href="<?php echo base_url(); ?>panel/mails/show/<?php echo $value->id; ?>" class="media-list-link <?php if ($value->active == 0) {
                                                                                                                      echo 'read';
                                                                                                                    } ?>">
                <div class="media pd-x-20 pd-y-15">
                  ...
                  <div class="media-body">
                    <div class="d-flex align-items-center justify-content-between mg-b-5">
                      <p class="mg-b-0 tx-medium tx-gray-800 tx-14"><?php echo $value->title; ?></p>
                      <span class="tx-11 tx-gray-500"><?php echo date('d/m/Y', strtotime($value->created)); ?></span>
                    </div><!-- d-flex -->
                    <p class="tx-12 mg-b-0"><?php echo $value->title; ?></p>
                  </div>
                </div><!-- media -->
              </a>
              <?php if ($i == 5) {
